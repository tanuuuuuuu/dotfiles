...
| Issue Type / 内容 | prefix |
|---|---|
| Feature, Enhancement | `feat` |
| Bug, Fix | `fix` |
| Documentation | `docs` |
| Refactor | `refactor` |
| Task, Chore, 設定変更 | `chore` |
| Research, Investigation | `chore`（または `research`） |
| Test | `test` |
...
| Issue タイトル | ブランチ名 |
|---|---|
| 「ログインボタンを追加する」（Feature, #123） | `feat/123-add-login-button` |
| 「null pointer エラーを修正する」（Bug, #456） | `fix/456-fix-null-pointer` |
| 「BigQuery MCP を調査する」（Research, #789） | `chore/789-investigate-bigquery-mcp` |
| 「README を更新する」（Documentation, #234） | `docs/234-update-readme` |
